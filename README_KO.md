...
[Releases](https://github.com/sglwsjxh/calendar-diary/releases) 페이지에서 시스템에 맞는 설치 파일을 다운로드하세요:
...
- **이슈 피드백**: [GitHub Issues](https://github.com/sglwsjxh/calendar-diary/issues)
- **프로젝트 홈페이지**: [GitHub Repository](https://github.com/sglwsjxh/calendar-diary)
