...
Перейдите на страницу [Releases](https://github.com/sglwsjxh/calendar-diary/releases), чтобы скачать установщик для вашей системы:
...
- **Обратная связь**: [GitHub Issues](https://github.com/sglwsjxh/calendar-diary/issues)
- **Страница проекта**: [GitHub Repository](https://github.com/sglwsjxh/calendar-diary)
