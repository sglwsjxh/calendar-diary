...
前往 [Releases](https://github.com/sglwsjxh/calendar-diary/releases) 頁面下載適合你系統的安裝包：
...
- **問題回饋**: [GitHub Issues](https://github.com/sglwsjxh/calendar-diary/issues)
- **專案首頁**: [GitHub Repository](https://github.com/sglwsjxh/calendar-diary)
